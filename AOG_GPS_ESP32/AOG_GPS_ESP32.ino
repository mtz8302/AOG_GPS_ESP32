...
//if connection to your network fails an accesspoint is opened: webinterface 192.168.137.1
...
struct set {
    ...
    // IO pins ESP32 side ----------------------------------------------------------------------------
    //209:27 16 25 17 LED 2
    //PANDA board 27 14 26 25 int 10 LED 15
    byte RX1 = 27;                    //F9P TX1 GPS pos
    byte TX1 = 16;                    //F9P RX1 GPS pos
    ...
    char ssid_ap[24] = "Fendt_209V";  // name of Access point, if no WiFi found, or no SSID1 .. SSID5 set !!

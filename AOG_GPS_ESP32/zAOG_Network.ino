    ...
    for (;;) {
        if (WiFi_connect_step == 0) {
            ...
            case 22:
                ...
                /*          case 23://init WiFi UDP listening to Autosteer
                              if (WiFiUDPBridgeToAOG.listen(Set.PortFromASt)) {
                                  Serial.print("UDP listening to AutoSteer port: ");
                                  Serial.println(Set.PortFromASt);
                              }
                              WiFi_connect_step++;
                              break;

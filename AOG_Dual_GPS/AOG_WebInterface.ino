...
void make_HTML01() {
    ...
    strcat(HTML_String, "<h1>GPS roof unit ESP for dual antenna</h1>");
    strcat(HTML_String, "for 2 UBlox receivers connected (1: UXB PVT 2: UBX RelPosNED)<br>");
    strcat(HTML_String,"supports data via USB/WiFi UDP, dual antenna, heading/roll filter and postion correction <br>");
    ...
    set_colgroup(250, 170, 150, 0, 0);

    strcat(HTML_String, "<tr>");
    strcat(HTML_String, "<td>Only load default values, does NOT save them</td>");
    ...
    strcat(HTML_String, "(GPS_unit_ESP_Net)<br><br>");
    strcat(HTML_String, "<table>");
